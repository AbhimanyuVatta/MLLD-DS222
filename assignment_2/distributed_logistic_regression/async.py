...
parameter_servers = ["10.24.1.211:2225"]
workers = [ "10.24.1.217:2225", "10.24.1.218:2225", "10.24.1.219:2225", "10.24.1.220:2225" ]
...
if FLAGS.job_name == "ps":
    ...
    with sv.prepare_or_wait_for_session(server.target) as sess:
        ...
        np.save("async_cost_acc1",save_cost_acc1)
        np.save("async_cost_acc2",save_cost_acc2)
