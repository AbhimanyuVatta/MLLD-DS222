...
parameter_servers = ["10.24.1.211:2227"]#, "10.24.1.202:2227"]
workers = [ "10.24.1.219:2227", "10.24.1.220:2227"]
...
if FLAGS.job_name == "ps":
  server.join()
	...
	# perform training cycles
        ...
        np.save("bulksync_cost_acc1",save_cost_acc1)
        np.save("bulksync_cost_acc2",save_cost_acc2)
