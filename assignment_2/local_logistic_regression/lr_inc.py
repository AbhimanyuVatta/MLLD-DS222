...
#lr_all=np.zeros((training_epochs,1))
...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        save_cost_acc_lr[epoch,2] = lr.eval()
        #lr_all[epoch,0]=lr.eval()
    ...
    np.save("lr_inc_cost_acc_lr",save_cost_acc_lr)
    #np.save("lr_inc_all",lr_all)
    #np.save("lr_inc_acc", save_accuracy)
